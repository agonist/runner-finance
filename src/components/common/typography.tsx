...
export const H2 = twc.h2`scroll-m-20 pb-2 text-3xl font-semibold tracking-tight first:mt-0`;

export const H3 = twc.h3`scroll-m-20 text-2xl font-semibold tracking-tight`;
